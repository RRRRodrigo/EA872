...
int main ()
{
  ...
  int prosseguir_jogo = 0;

  Teclado *teclado = new Teclado();
  teclado->init( &(prosseguir_jogo) );

  while(!prosseguir_jogo){} //paraliza até o cliente conectar

  Projetil *projetil = new Projetil();
  projetil->gerar(0.98); //O mapa e gerado aleatoriamente, mais detalhes na funcao gerar
